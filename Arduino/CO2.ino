...
/* =================================================================================
 * == Código que envía datos de un sensor a la base de datos de MediaLab          ==
 * =================================================================================
 * 
 * Descripción:
...
//#include "Adafruit_CCS811.h"              // Para sensor TVOC CCS811 (habilitar si se va a usar)
#include "esp_wpa2.h" 
// Librerias base Arduino
#include <stdio.h>
#include <string.h>
#include <Arduino.h>
...
const int freq = 2000, ledChannel_buzzer = 0, resolution = 10, piezoPin = 18; // frecuencia del zumbador, canal, resolucion y output data pin
...
void leer()
{
  ...
  if (co2 < aceptable)
    modo = 0;
  else if ((co2 >= aceptable) && (co2 < precaucion))
    modo = 1;
  else
    modo = 2;
