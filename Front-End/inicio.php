...
<html class="no-js" lang="es">
  ...
  <body style="background: WhiteSmoke;">
    ...
    <script type="text/javascript">
      //almaceno algunas variables guardadas en la sesión que me serán útiles a lo largo de la ejecución
    ...
    <div class="row p-1 text-white shadow-sm" style="background: LightSeaGreen;">
      ...
      <div class="col-9 text-end">
        <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" style="margin-right:15%; margin-top:26px; border: none; color:#FFFFFF; box-shadow:none; font-size: 26px; background-color:#20B2AA;"><i class="bi bi-list"></i> Menú</button>
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
          ...
          <div class="offcanvas-body">
            <ul class="list-group list-group-flush">
              <li class="list-group-item" data-bs-dismiss="offcanvas"><a href="#" id="index" style="color:#20B2AA; font-size:20px; display: block;">Inicio</a></li>
              <li class="list-group-item" data-bs-dismiss="offcanvas"><a href="#" id="menuSensors" style="color:#20B2AA; font-size:20px; display: block;">Sensores</a></li>
              <li class="list-group-item" data-bs-dismiss="offcanvas"><a href="#" id="menuAlerts" style="color:#20B2AA; font-size:20px; display: block;">Alertas</a></li>
    ...
    <main class="container-lg border-start border-5 rounded-3 shadow p-4 mb-4 bg-white" style="margin-top:15px; min-height:730px; border-color: LightSeaGreen !important;">
      ...
      <div class="row">
        <div class="container overflow-auto" style="min-height:300px;" id="info"></div>
      </div>
    </main>
    ...
    <script type="module" src="js/inicio.js" async></script>
